...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void fetchSearchedProducts() async {
    searchedProductsList = await searchServices.fetchProductBySearch(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: searchedProductsList == null
            ? const Loader()
            : Column(
                children: [
                  const AddressBox(),
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return SearchedProductWidget(
                          product: searchedProductsList![index],
                        );
                      },
                    ),
                  ),
